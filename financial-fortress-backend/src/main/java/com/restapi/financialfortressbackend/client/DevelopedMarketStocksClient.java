...
public class DevelopedMarketStocksClient {
    ...
    public BigDecimal getDayStockValuation() {
        ...
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create("https://ftl.fasttrack.net/v1/data/M-CNA/range"))
    ...
    public List<BigDecimal> getYearStockValuation() {
        ...
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create("https://ftl.fasttrack.net/v1/data/M-CNA/range?start=2021-AUG-29&end=2022-AUG-29"))
                .header("Content-Type", "application/json")
                .header("appid", API_KEY)
                .header("token", API_TOKEN)
                .method("GET", HttpRequest.BodyPublishers.noBody())
